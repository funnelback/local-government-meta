...
<#macro AutoCompleteTemplate>
	<script id="auto-completion-people" type="text/x-handlebar-template">
		<div class="fb-auto-complete--non-organic tt-dataset-people">
            <h5 class="fb-auto-complete__body__primary-text">{{extra.disp.metaData.peopleFirstName}} {{extra.disp.metaData.peopleLastName}}</h6>

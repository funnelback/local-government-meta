...
<#-- 
    ...
    Setting modern ui click and search links
    Check for JS libraries that needs to be added/remove
-->
    ...
    <div class="fb-container">
        <main class="main" role="main">
            <section class="content-wrapper">
                ...
                <p>
                    Funnelback is responsible for generating a standalone HTML page with all 
                ...
                <p>
                    Note: This normally requires the user to navigate from one domain to another.
                </p>
                <pre>https://example.com -> https://search.example.com</pre>

                <p> 
                    Include a form with an input which submits the users query 
...
<form
    ...
    <input type="hidden" name="profile" value="${question.profile!}">
                ...
                <p>
                    ...
                    than a full HTML page. The fragment is usually enclosed in a 
                    &lt;div&gt;&lt;/div&gt; or similar block level tag. This fragment
                    will be embedded as-is inside the page generated by the Content 
                    Management System (CMS).
                </p>

                <p> 
                    Links to the partial template can be found below: 
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.7.6/handlebars.min.js" integrity="sha512-zT3zHcFYbQwjHdKjCu6OMmETx8fJA9S7E6W7kBeFxultf75OPTYUJigEKX58qgyQMi1m1EgenfjMXlRZG8BXaw==" crossorigin="anonymous"></script>
                ...
                <p>
                    Style the search so that the implementation fits in with the 
                    overall look and feel of the website in the CMS.
                </p>
